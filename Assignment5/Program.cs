...
namespace App
{
    ...
    class Program
    {
        ...
        {
            Console.Write("\nName :- NAGDEV CHAITANYA GOVIND");
            Console.Write($"\nTime :- {DateTime.Now.ToString("dddd, dd MMMM yyyy hh:mm:ss tt")}\n");

            Console.Write("\n-------------- GENERICS ---------------\n");
            Indica indica1 = new Indica("Petrol", 5, "GJ-01-KN-0024", IVehicle.RentType.days, 3, 1000, new DateOnly(2020, 12, 16));
            MBenzEclass mBenz1 = new MBenzEclass(7, "GJ-02-AB-7875", IVehicle.RentType.kms, 2, 17, new DateOnly(2021, 07, 18));
            Qualis qualis1 = new Qualis("Diesel", 7, "Gj-03-GS-5700", IVehicle.RentType.kms, 8, 13, new DateOnly(2022, 11, 21));
            Davidharley dHarley1 = new Davidharley("GJ-08-HI-0210", IVehicle.RentType.kms, 1, 14, new DateOnly(2022, 02, 28));
            MBenzEclass mBenz2 = new MBenzEclass(7, "GJ-09-AB-7875", IVehicle.RentType.kms, 9, 17, new DateOnly(2020, 10, 26));
